...
public class KalkulatorDendaTest {
    ...
    void setUp() {
        ...
        anggotaDosen = new Anggota("D001", "Dr. Faculty", "faculty@dosen.ac.id", "081234567891", Anggota.TipeAnggota.DOSEN);
    ...
    void testHitungDendaMahasiswaTigaHariTerlambat() {
        LocalDate tanggalPinjam = LocalDate.now().minusDays(6);
    ...
    void testDendaTidakMelebihiBatasMaksimal() {
        ...
        LocalDate tanggalPinjam = LocalDate.now().minusDays(150);
    ...
    @Test
    @DisplayName("Tarif denda harian sesuai tipe anggota")
    void testGetTarifDendaHarian() {
        ...
        assertEquals(3000.0, kalkulatorDenda.getTarifDendaHarian(Anggota.TipeAnggota.UMUM));
    ...
    void testGetDendaMaksimal() {
        ...
        assertEquals(75000.0, kalkulatorDenda.getDendaMaksimal(Anggota.TipeAnggota.DOSEN));
    ...
    void testAdaDenda() {
        ...
        LocalDate tanggalPinjamTerlambat = LocalDate.now().minusDays(10);
        Peminjaman peminjamanTerlambat = new Peminjaman("P001", "M001", "1234567890",
                tanggalPinjamTerlambat, LocalDate.now().minusDays(2));
