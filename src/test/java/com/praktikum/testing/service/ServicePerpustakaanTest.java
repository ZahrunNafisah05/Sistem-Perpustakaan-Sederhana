...
public class ServicePerpustakaanTest {
    ...
    void testTambahBukuGagalKetikaBukuSudahAda() {
        // Arrange
    ...
    void testGetJumlahTersediaBukuTidakAda() {
        // Arrange
        when(mockRepositoryBuku.cariByIsbn("999999999")).thenReturn(Optional.empty());

        // Act
        int jumlah = servicePerpustakaan.getJumlahTersedia("999999999");
