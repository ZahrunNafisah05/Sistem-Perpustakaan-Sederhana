...
class MockRepositoryBukuTest {
    ...
    @BeforeEach
    void setUp() {
        // Real mock repository sebelum setiap test
    ...
    void testSimpanBukuBaru() {
        ...
        assertTrue(mockRepository.mengandung("1234567890"), "Repository harus mengandung buku1");
    }
    ...
    void testSimpanBukuDenganIsbnNull() {
        // Arrange
        Buku bukuInvalid = new Buku(null, "Judul tanpa ISBN", "Pengarang", 1, 1000.0);
        bukuInvalid.setIsbn(null); // Judul "Judul tanpa ISBN"
    ...
    void testSimpanBukuDuplikat() {
        ...
        Buku bukuUpdated = new Buku("1234567890", "Java Programming Updated", "John Doe Updated", 3, 200000.0);
    ...
    void testCariByIsbnBukuTidakDitemukan() {
        ...
        // Act
        Optional<Buku> hasil = mockRepository.cariByIsbn("999999999");
    ...
    void testHapusBukuYangAda() {
        ...
        assertFalse(mockRepository.mengandung("1234567890"), "Buku1 sudah harus dihapus");
    ...
    void testHapusBukuYangTidakAda() {
        ...
        // Act
        boolean hasil = mockRepository.hapus("999999999");
    ...
    void testUpdateJumlahTersediaBukuTidakDitemukan() {
        // Act
        boolean hasil = mockRepository.updateJumlahTersedia("999999999", 2);
